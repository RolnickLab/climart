...
import climart.models.GraphNet.constants as gn_constants
from climart.models.GraphNet.constants import GraphComponentToTensor, AggregationTypes, NODES, EDGES, GLOBALS
