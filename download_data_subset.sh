...
for x in 1997 1998 2014 ;do  curl https://climart.blob.core.windows.net/climart-dataset/inputs/$x.h5 --output ${data_dir}/inputs/$x.h5; done
...
for x in 1997 1998 2014 ;do  curl https://climart.blob.core.windows.net/climart-dataset/outputs_pristine/$x.h5 --output ${data_dir}/outputs_pristine/$x.h5; done
